...
def create_db_middleware():
    try:
        # Create the database middleware file
        db_content = '''from fastapi import Request, Response
...
'''
        ...
        with open("src/api/middleware/db_middleware.py", "w") as f:
            f.write(db_content)
...
'''
        ...
        print("✅ Database middleware has been created successfully!")
        print("✅ Requirements.txt has been updated with SQLAlchemy and asyncpg dependencies")
        return True
    except Exception as e:
...
if __name__ == "__main__":
    response = input("Do you want to create the database middleware? (y/n): ")
    if response.lower() == 'y':
