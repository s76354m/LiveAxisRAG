...
def create_logging_middleware():
    try:
        # Create the logging middleware file
...
'''
        ...
        with open("src/api/middleware/logging_middleware.py", "w") as f:
...
'''
        ...
        print("✅ Logging middleware has been created successfully!")
        return True
    except Exception as e:
...
if __name__ == "__main__":
    response = input("Do you want to create the logging middleware? (y/n): ")
    if response.lower() == 'y':
