...
def create_rate_limiter():
    try:
        ...
        rate_limiter_content = '''from fastapi import Request, HTTPException
...
'''
        ...
        with open("src/api/middleware/rate_limiter.py", "w") as f:
...
'''
        ...
        print("✅ Rate limiting middleware has been created successfully!")
        return True
...
if __name__ == "__main__":
    response = input("Do you want to create the rate limiting middleware? (y/n): ")
    if response.lower() == 'y':
        create_rate_limiter()
    else:
