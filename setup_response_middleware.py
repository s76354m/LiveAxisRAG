...
def create_response_middleware():
    try:
        # Create the response formatting middleware file
        response_content = '''from fastapi import Request, Response
...
'''
        ...
        with open("src/api/middleware/response_middleware.py", "w") as f:
...
'''
        ...
        print("✅ Response formatting middleware has been created successfully!")
        return True
    except Exception as e:
...
if __name__ == "__main__":
    response = input("Do you want to create the response formatting middleware? (y/n): ")
    if response.lower() == 'y':
